# Session 01 — Investiture

## Starting state

- Location: Ark Mechanicus *Recollections of Rust*, late in Explorator
  Rotation #46; opening in memory (the Error Chorus), then present day.
- Present characters: Adept Vesper Antiphon-6 (Ryan; he/him).
- Current mission: none yet — the Investiture prelude; first mandate to be
  issued in play.
- Wounds 0/13, Critical Wounds 0, Fate 3/3, Corruption 0, XP 25 banked.
- Relevant Influence: Vesper +1 Adeptus Mechanicus.

## Recap

First session; no prior fiction. Table conventions: he/him for Vesper;
out-of-character remarks prefixed `(OOC: ...)`; seeded rolls via
`tools/imtool.py`.

## Scenes and outcomes

1. **The Error Chorus (flashback, ~11 years ago).** Young Vesper blocked
   the release of cogitator unit Theta-Kappa-77-KO, crediting Overseer
   Cambric-4's stamp with the reactivation (face-saving gambit). Easy
   Awareness (Sound) Test failed marginally (78 vs 70, seed
   705943461075405674): he heard truly but spoke imprecisely. Cambric
   suspended the unit per code 9-Theta under VESPER'S designation. Ryan
   authored the log entry; canon text in the transcript ("threshold of
   non-augmented audition" — author had flesh ears; the buried miracle).
   Auscultation vindicated him: spirit distressed, non-expired; unit
   preserved and carried up-deck, destination untold.
2. **The summons (present day).** Priority chime + chronicler servo-skull
...
- Overseer Cambric-4 (flashback; brief: gm/npc-briefs/cambric-4.md)
- Magos Acquisitor Herazade Vex-Kappa-9 (brief: gm/npc-briefs/herazade.md,
